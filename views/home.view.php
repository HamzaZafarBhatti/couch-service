                                                    ...
                                                    <script type="text/javascript">
                                                        function alertdelete_e<?php echo $exercise['exercise_id']; ?>() {
                                                            swal({
                                                                ...
                                                                window.location.href = "../controller/delete_exercise.php?id=<?php echo $exercise['exercise_id']; ?>"
                                                            });
                                                        }
                                                    </script>
                                                    ...
                                                    <script type="text/javascript">
                                                        function alertdelete_w<?php echo $workout['workout_id']; ?>() {
                                                            swal({
                                                                ...
                                                                window.location.href = "../controller/delete_workout.php?id=<?php echo $workout['workout_id']; ?>"
                                                            });
                                                        }
                                                    </script>
                                                    ...
                                                    <script type="text/javascript">
                                                        function alertdelete_p<?php echo $post['post_id']; ?>() {
                                                            swal({
                                                                ...
                                                                window.location.href = "../controller/delete_post.php?id=<?php echo $post['post_id']; ?>"
                                                            });
                                                        }
                                                    </script>
                                ...
                                <div class="table-responsive text-no-wrap">
                                    <table class="table">
                                        <tbody class="text-middle">
                                            <?php
                                            if (isset($diets)) :
                                                foreach (array_slice($diets, 0, 5) as $diet) :
                                            ?>
                                                    <tr>
                                                        <td class="product">
                                                    ...
                                                    <script type="text/javascript">
                                                        function alertdelete_r<?php echo $diet['diet_id']; ?>() {
                                                            swal({
                                                                ...
                                                                window.location.href = "../controller/delete_diet.php?id=<?php echo $diet['diet_id']; ?>"
                                                            });
                                                        }
                                                    </script>
