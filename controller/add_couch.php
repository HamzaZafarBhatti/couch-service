...
if (isset($_SESSION['username'])) {
	...
	$errors = '';
    $sql= "INSERT INTO couch (user_id, username ,is_available, from_date, to_date, address, city, country) VALUES ('$user_id', '$username', '$is_available', '$from_date', '$to_date', '$address', '$city', '$country', '$couch_img', '$wish_list')";
